...
gaussian_blurred = cv2.GaussianBlur(gaussian_blurred, (7, 7), sigmaX=0)
cv2.imwrite('denoised_gaussian.jpg', gaussian_blurred)
...
cv2.imwrite('denoised_bilateral.jpg', bilateral_filtered)
...
cv2.imwrite('denoised_nlmeans.jpg', nlmeans_denoised)
...
cv2.imwrite('denoised_channelwise.jpg', channelwise_denoised)
...
cv2.imwrite('denoised_bm3d.jpg', bm3d_denoised)
