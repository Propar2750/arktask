...
def method_1(image):
    ...
    # Save outputs
    cv2.imwrite(os.path.join(SCRIPT_DIR, 'method1_filtered.jpg'), filtered_image)
    cv2.imwrite(os.path.join(SCRIPT_DIR, 'method1_binary.jpg'), binary_image)
    cv2.imwrite(os.path.join(SCRIPT_DIR, 'method1_edges_canny.jpg'), edges_canny)
